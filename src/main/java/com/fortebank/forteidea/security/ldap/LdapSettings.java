package com.fortebank.forteidea.security.ldap;

import org.springframework.boot.context.properties.ConfigurationProperties;
import org.springframework.context.annotation.Configuration;

@Configuration
@ConfigurationProperties(prefix = "com.fortebank.security.ldap")
public class LdapSettings {
    /**
     * Specifies the ldap server URL.
     * For example, "ldap://ldap.example.com:33389/dc=fortebank,dc=com".
     */
    private String url;
